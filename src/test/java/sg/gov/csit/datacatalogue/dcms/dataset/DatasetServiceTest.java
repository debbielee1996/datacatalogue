...
public class DatasetServiceTest {
    ...
    public void createNewDataset_GivenDatasetIdInDb_ShouldThrowException() {
        ...
        // assert
        assertThrows(DatasetExistsException.class, () -> datasetService.createNewDataset("mock", "", "123",false));
    }
    ...
    public void createNewDataset_GivenDatasetIdInDbAndOfficerNotExists_ShouldThrowException() {
        ...
        // assert
        assertThrows(OfficerNotFoundException.class, () -> datasetService.createNewDataset("mock", "", "123",false));
    }
    ...
    public void createNewDataset_GivenDatasetIdNotInDb_ShouldReturnTrue() {
        ...
        // assert
        assertTrue(() -> datasetService.createNewDataset("DatasetServiceTest_mockDatabase", "", pf,false));
    }
